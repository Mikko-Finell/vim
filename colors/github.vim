...
hi Visual   ctermfg=15   ctermbg=61  guifg=#FF0000   guibg=#3465a3
hi VisualNOS   ctermfg=15   ctermbg=24  guifg=#FF0000   guibg=#204a87
...
if version >= 700
    hi CursorLine cterm=NONE ctermbg=254 guibg=#FFFFFF
